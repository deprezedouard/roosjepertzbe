...
goedgezind_speellijst: "<br><span style=\"color: black; background-color: white;\">Tournee
  ...
  Plaza in <strong>Duffel</strong>  //  <a href=\"https://www.cinema-plaza.be/programma\"
...
speellijst: "<br><strong>14/09/26</strong>  MC voor Jens Deferm, Jan Linssen en Lev
  ...
  set in Wolinski comedy club in  <strong>Brugge</strong> //  <a href=\"https://www.ticketsbrugge.be/nl/events/pieter-verelst-en-roosje-pertz-live-in-wolinski?show=15886859\"
  ...
  comedy in <strong>Minard in Gent</strong> //  <a href=\"https://minard.be/voorstelling/edouard-de-prez-9-jaar-palaver-live/\"
    ...
    <div class="container">
      <div class="row pb-5">
        ...
        <div class="d-flex justify-content-center mt-4 col-12 col-md-10">
          <iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/show/525pbJO7cxgSCCCy358XOx?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"></div>
        </div>
      </div>
    </div>
  </div>
